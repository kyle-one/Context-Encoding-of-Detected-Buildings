...
def get_logger():
    ...
    fHandler = logging.FileHandler("{}/{}.log".format(config.WORK_DIR + '/log', '9_16_SLEDDing_just_tail,reverse'),
                                   mode='w')
...
if __name__ == '__main__':
    ...
    list_result['SLEDDing_just_tail_reverse'] = list_result1
    with open(config.WORK_DIR + '/3_3_SLEDDing_reverse.json', 'w+') as f:
