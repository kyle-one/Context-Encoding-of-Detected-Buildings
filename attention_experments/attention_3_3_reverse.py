...
class config:
    ...
    WORK_DIR = '/Public/TianYu/YongkunLiu/beauty_rnn_work_dir3_3'
    BATCH_SIZE = 64
...
def get_logger():
    ...
    fHandler = logging.FileHandler("{}/{}.log".format(config.WORK_DIR + '/log', '9_16_all_hidden_reverse'), mode='w')
...
if __name__ == '__main__':
    ...
    list_result['all_hidden_reverse'] = list_result1
    with open(config.WORK_DIR + '/attention_3_3_reverse.json', 'w+') as f:
