...
def get_logger():
    ...
    fHandler = logging.FileHandler("{}/{}.log".format(config.WORK_DIR + '/log', '9_16_SLEDDing.log'), mode='w')
...
if __name__ == '__main__':
    ...
    #     for i in BIDIRECTIONALs:
    list_result1["[DETECTION={},FUN={}]".format('cascade_rcnn_r101', 'Spatial_Layout_Encoding')] = []
    for b in range(5):
        logger.info("[DETECTION={},BIDIRECTIONAL={}]".format('cascade_rcnn_r101', 'Spatial_Layout_Encoding'))
        ...
        model = train(model, train_iter, val_iter, 40, lr_period, lr_decay)
    ...
    list_result['SLEDDing'] = list_result1
    with open(config.WORK_DIR + '/3_3_SLEDDing_reverese_01.json', 'w+') as f:
