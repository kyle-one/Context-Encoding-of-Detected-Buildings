...
def get_logger():
    ...
    fHandler = logging.FileHandler("{}/{}.log".format(config.WORK_DIR+'/log','9_16_just_tail_hidden'), mode='w')
...
if __name__ == '__main__':
    ...
    for i in RNNs:
        for j in BIDIRECTIONALs:
            ...
            for b in range(5):
                ...
                model=RNN(8,16,4,2,j,i).to(config.device)
    ...
    list_result['just_tail_hidden']=list_result1
    with open(config.WORK_DIR+'/9_16_just_tail_hidden.json', 'w+') as f:
