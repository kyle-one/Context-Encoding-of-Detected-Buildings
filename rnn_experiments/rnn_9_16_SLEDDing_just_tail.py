...
def get_logger():
    ...
    fHandler = logging.FileHandler("{}/{}.log".format(config.WORK_DIR+'/log','9_16_SLEDDing_just_tail'), mode='w')
...
if __name__ == '__main__':
    ...
    #连接全节点
    logger.info('--------------------SLEDDing_just_tail--------------------')
    RNNs=['RNN','LSTM','GRU']
    DETECTIONs=['cascade_rcnn_r101','cascade_rcnn_r50','faster_rcnn_r101','faster_rcnn_r50']
    BIDIRECTIONALs=['True','False']
    FUNs=['None','multi_task','Spatial_Layout_Encoding']
    ...
    list_result['SLEDDing_just_tail']=list_result1
    with open(config.WORK_DIR+'/9_16_SLEDDing_just_tail.json', 'w+') as f:
