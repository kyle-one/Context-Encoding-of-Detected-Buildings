...
if __name__ == '__main__':
    ...
    for i in RNNs:
        for j in BIDIRECTIONALs:
            list_result1["[RNN={},DETECTION={},BIDIRECTIONAL={},FUN={}]".format(i,'cascade_rcnn_r101',j,'None')]=[]
            for b in range(5):

                logger.info("[RNN={},DETECTION={},BIDIRECTIONAL={},FUN={}]".format(i,'cascade_rcnn_r101',j,'None'))
                ...
                model=RNN2(8,16,4,2,j,i).to(config.device)
                ...
                list_result1["[RNN={},DETECTION={},BIDIRECTIONAL={},FUN={}]".format(i,'cascade_rcnn_r101',j,'None')].append(result)
                logger.info(str(maxtir))
                logger.info(str(F1(maxtir))+'\n')
    list_result['all_hidden_reverse']=list_result1
    with open(config.WORK_DIR+'/9_16_all_hidden_reverse.json', 'w+') as f:
